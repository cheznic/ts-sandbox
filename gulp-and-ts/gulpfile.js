...
exports.build = series(buildClean, parallel(buildCss, buildHtml, buildTs, buildJs));
exports.stage = series(stageClean, parallel(stageCss, stageHtml, stageTs, stageJs));
exports.default = parallel(buildCss, buildHtml, buildTs, buildJs)
